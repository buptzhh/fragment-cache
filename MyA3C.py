...
from envs.CacheFragmentSimulatorEnv_bi import CacheSimulator
...
if __name__ == "__main__":
    ...
    saver.save(SESS, 'model/fragment_model_s1/cache_model_bi.ckpt')

    plt.plot(np.arange(len(GLOBAL_RUNNING_R)), GLOBAL_RUNNING_R)
    plt.xlabel('step')
    plt.ylabel('reward')
    plt.savefig("fig_bi.png")
